...
To enable or disable PDF export for visitors to your [published docs site](../../collaboration/broken-reference/), open the docs site’s dashboard and click the **Settings** tab, then select the **Features** section. You can toggle it on and off here.
