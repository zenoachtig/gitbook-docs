...
1.  Go to the organization’s settings page. You can click on the settings
    ...
    <picture><source srcset="../untitled/.gitbook/assets/settings_icon_dark.svg" media="(prefers-color-scheme: dark)"><img src="../untitled/.gitbook/assets/settings_icon_light.svg" alt="The Settings icon in GitBook"></picture>
