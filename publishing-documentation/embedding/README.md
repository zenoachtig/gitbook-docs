...
{% hint style="info" %}
If your docs use [Authenticated Access](../authenticated-access/), follow the steps in [how to set up the embed with authenticated docs](using-with-authenticated-docs.md).
{% endhint %}
{% endstep %}
